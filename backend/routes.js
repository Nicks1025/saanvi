...
const notificationApi = require('./features/notifications/notificationApi');
...
module.exports = function(app) {
  const apis = [loginApi, signupApi, userApi, adminApi, wordSearchApi, mfaApi, healthApi, chatApi, notificationApi];
